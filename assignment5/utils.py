...
def pad_sents_char(sents, char_pad_token):
    ...
    #print('initial len of sents', [len(sent) for sent in sents])
    #print('initial len of words', [[len(word) for word in sent] for sent in sents])
    ...
    #print('final len of sents', [len(sent) for sent in sents_padded])
    #print('initial len of words', [[len(word) for word in sent] for sent in sents_padded])
    ### END YOUR CODE
